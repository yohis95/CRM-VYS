...
function modificar() {		
			...
			{
			document.formulario.action = "procesos/modificar_cliente.php";
			document.formulario.submit();
			}
	...
	<header>
		...
		<div class="container">
			...
			<div class="form-group col-md-6"> 
    			...
    			<input type="text" class="form-control" name="nombre" id="nombre" value="<?=$nombre?>" placeholder="Ingrese nombre del cliente">
    		</div>

    		<div class="form-group col-md-6"> <br>
    			<label for="apellido">Apellido</label><br>
    			<input type="text" class="form-control" name="apellido" id="apellido" value="<?=$apellido?>" placeholder="Ingrese apellido del cliente" >
    		</div>

    		<div class="form-group col-md-6"> <br>
    			<label for="dni">Dni</label><br>
    			<input type="text" class="form-control" name="dni" id="dni" value="<?=$dni?>" placeholder="Ingrese dni del cliente" >
			</div>

			<div class="form-group col-md-6"> <br>
    			<label for="domicilio">Domicilio</label> <br>
    			<input type="text" class="form-control" name="domicilio" id="domicilio" value="<?=$domicilio?>" placeholder="Ingrese domicilio del cliente" >
			</div>

			<div class="form-group col-md-6"> <br>
    			<label for="email">Email</label> <br>
    			<input type="email" class="form-control" name="email" id="email" value="<?=$email?>" placeholder="Ingrese email del cliente" >
			</div>

			<div class="form-group col-md-6"> <br>
    			<label for="telefono">Telefono</label> <br>
    			<input type="text" class="form-control" name="telefono" id="telefono" value="<?=$telefono?>" placeholder="Ingrese telefono del cliente">
			</div>

			<div class="form-group col-md-6"> <br>
    			<label for="localidad">Localidad</label> <br>
    			<input type="text" class="form-control" name="localidad" id="localidad" value="<?=$localidad?>" placeholder="Ingrese localidad">
			</div>
    	...
    	<!--	<div class="form-group ">
					...
					<div class="form-group "> <br>
		                ...
		                <input type="submit" class="btn btn-primary"   value="Guardar cliente" onClick="modificar()" >
		            </div>    
