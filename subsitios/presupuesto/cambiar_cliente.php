...
function agregar() {
			...
			{
			document.formulario.action = "procesos/modificar_cliente_esporadico.php?id_presupuesto=<?=$id_presupuesto?>";
			document.formulario.submit();
		}
...
function seleccionar_cliente(){
			...
			{
			document.formulario.action = "procesos/modificar_seleccion_cliente.php?id_presupuesto=<?=$id_presupuesto?>";
			document.formulario.submit();
		}	
}
